...
<style>text{font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,sans-serif}.title{font-size:22px;font-weight:700;fill:#f0f6fc}.label{font-size:14px;fill:#8b949e}.value{font-size:30px;font-weight:700;fill:#58a6ff}.detail{font-size:13px;fill:#8b949e}.footer{font-size:11px;fill:#6e7681}.metric-icon{fill:none;stroke:#8b949e;stroke-width:1.5;stroke-linecap:round;stroke-linejoin:round}</style><rect width="720" height="246" rx="12" fill="#0d1117"/>
...
<g class="metric-icon" transform="translate(28 120) scale(1.5)"><path d="M2 1.5h9.5A1.5 1.5 0 0 1 13 3v11H3.5A1.5 1.5 0 0 1 2 12.5z"/><path d="M5 1.5V14"/></g><text class="label" x="28" y="108">REPOSITORIES</text><text class="value" x="60" y="142">${format(total.repos)}</text>
<g class="metric-icon" transform="translate(278 120) scale(1.5)"><path d="m8 1.5 1.85 3.75 4.15.6-3 2.92.7 4.13L8 10.97 4.3 12.9 5 8.77 2 5.85l4.15-.6z"/></g><text class="label" x="278" y="108">STARS</text><text class="value" x="310" y="142">${format(total.stars)}</text>
<g class="metric-icon" transform="translate(448 120) scale(1.5)"><path d="M1 8h4.5M10.5 8H15"/><circle cx="8" cy="8" r="2.5"/></g><text class="label" x="448" y="108">AUTHORED COMMITS</text><text class="value" x="480" y="142">${format(total.commits)}</text>
